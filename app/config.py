...
class Settings(BaseSettings):
    ...
    For example, to override `model_name`, set the environment variable
    `MLOPS_MODEL_NAME="custom-model"`. Pydantic handles the type casting and
    validation of these settings.
